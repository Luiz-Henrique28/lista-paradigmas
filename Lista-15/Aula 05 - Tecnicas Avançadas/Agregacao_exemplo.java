...
class Pessoa {
    ...
    public Pessoa(String nome, int idade) {
        this.nome = nome;
        this.idade = idade;
        this.endereco = null;  // Inicialmente sem endereÃ§o
    }
    ...
    public void mostrarInformacoes() {
        ...
        if (endereco != null) {
            ...
            System.out.println("EndereÃ§o nÃ£o disponÃ­vel");
        }
    }
...
class Empresa {
    ...
    public void listarFuncionarios() {
        System.out.println("FuncionÃ¡rios da empresa " + nome + ":");
...
public class Agregacao_exemplo {
    public static void main(String[] args) {
        ...
        Pessoa pessoa1 = new Pessoa("JoÃ£o", 30);
        pessoa1.adicionarEndereco(endereco1);

        Endereco endereco2 = new Endereco("Rua SecundÃ¡ria", "Cidade B", "Estado Y", "98765-432");
